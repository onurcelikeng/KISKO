...
var DatePicker = /** @class */ (function () {
    function DatePicker() {
        ...
        this.defaultSettings = {
            ...
            cal_days_labels: ['Paz', 'Pzt', 'Sal', 'Çar', 'Per', 'Cum', 'Cmt'],
            cal_full_days_lables: ["Pazar", "Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma", "Cumartesi"],
            cal_months_labels: ['Ocak', 'Şubat', 'Mart', 'Nisan',
                'Mayıs', 'Haziran', 'Temmuz', 'Ağustos', 'Eylül',
                'Ekim', 'Kasım', 'Aralık'],
            cal_months_labels_short: ['Oca', 'Şub', 'Mar', 'Nis',
                'May', 'Haz', 'Tem', 'Ağu', 'Eyl',
                'Eki', 'Kas', 'Ara'],
            closeOnSelect: true
        };
