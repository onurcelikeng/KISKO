...
<div *ngIf="(show && (mode === 'dropdown' || mode === 'popup')) || mode === 'inline'"
     ...
     dialogPosition [directiveElementRef]="directiveElementRef">
    <div class="picker-box">
        <dialog-picker-header [dialogType]="dialogType" [selectedMoment]="selectedMoment" [now]="now" (onDialogTypeChange)="toggleDialogType($event)"></dialog-picker-header>
        <div class="picker-content">
            <dialog-date-panel *ngIf="pickerType === 'both' || pickerType === 'date'"
                               [ngClass]="{'picker-hidden': dialogType === 0}"
                               [selectedMoment]="selectedMoment"
                               [dialogType]="dialogType"
                               (onDialogTypeChange)="toggleDialogType($event)"
